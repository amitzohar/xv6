...
main(void)
{
  ...
  7a:	74 c4                	je     40 <main+0x40>
      printf(1, "zombie!\n");
  7c:	c7 44 24 04 42 08 00 	movl   $0x842,0x4(%esp)
  83:	00 
  ...
  ad:	e8 90 02 00 00       	call   342 <exit>
    ...
    if(pid == 0){
      exec("/bin/sh", argv);
  b2:	c7 44 24 04 c8 0a 00 	movl   $0xac8,0x4(%esp)
  b9:	00 
  ba:	c7 04 24 24 08 00 00 	movl   $0x824,(%esp)
  c1:	e8 b4 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  c6:	c7 44 24 04 2c 08 00 	movl   $0x82c,0x4(%esp)
  cd:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 429:	0f b6 92 52 08 00 00 	movzbl 0x852(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5bf:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 5c1:	b8 4b 08 00 00       	mov    $0x84b,%eax
