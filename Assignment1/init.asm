...
main(void)
{
  ...
  74:	74 ca                	je     40 <main+0x40>
      printf(1, "zombie!\n");
  76:	c7 44 24 04 32 08 00 	movl   $0x832,0x4(%esp)
  7d:	00 
  ...
  b4:	e8 b1 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  b9:	c7 44 24 04 1c 08 00 	movl   $0x81c,0x4(%esp)
  c0:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 419:	0f b6 92 42 08 00 00 	movzbl 0x842(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5af:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 5b1:	b8 3b 08 00 00       	mov    $0x83b,%eax
